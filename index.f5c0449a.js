...
var data = {
    ...
    "arabic": {
        ...
        "navServ": "خدماتنا",
        "navProject": "ابدأ الآن  ",
        "servtitle": "ماذا تقدم انيجما ؟",
        "servbio": "تقدم انيجما الحلول الرقمية بخدماتها واسعة النطاق , و أنظمة ذكية ومبتكرة من خلال منتجاتها",
        ...
        "mainBioMedia": "تقدم Enigma أحدث خدمات المراقبة للأخبار الصحفية اليومية ؛ تغطية وسائل الإعلام المطبوعة والإلكترونية والمذاعة والتواصل الإجتماعي عنك وعن منافسيك وأخبار مجالك في أي مكان.",
        ...
        "mainBioUi": "ضمن انيجما لك تصميمًا آمنًا وفعالًا متبعة في ذالك القواعد الأساسية لبناء وتحسين واجهة وتجربة المستخدم لتجاوز التحديات و الصعوبات التي يواجهها عملاؤك.",
        "readmoreservcies": " اقرأ المزيد ! ",
        "contactusfildeshint": 'لنتواصل',
        "contactusfildestitle": 'تواصل معنا الآن',
        "contactusfildesparagraph": '  نبني علاقات طويلة الأمد مع عملائنا ، و إعطاء الأولوية لعملائنا أمر لا بد منه و لنتواصل الآن ونباشر العمل .',
        "contactussend": 'إرسل',
        "footercontenttitlesub": 'اشترك في نشرتنا الإخبارية ',
